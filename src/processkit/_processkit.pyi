...
# A program / path argument: anything `os.fspath` accepts (str, bytes, or an
# os.PathLike of either) — matching how `subprocess` takes a program.
StrPath = str | bytes | os.PathLike[str] | os.PathLike[bytes]
...
class RunningProcess:
    ...
    def take_stdin(self) -> ProcessStdin | None:
        """The writable stdin handle, or ``None`` if stdin was not kept open —
        the `Command` must have used ``keep_stdin_open()``."""
